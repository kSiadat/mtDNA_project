...
I have now finished parsing the [wiki page](https://en.wikipedia.org/wiki/Human_mitochondrial_genetics), but I still need to create a karyotype file for circos using the data.